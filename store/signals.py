...
def create_default_items(sender, **kwargs):
    ...
    if sender.name == "store":  # store 앱이 마이그레이션될 때만 실행
        default_items = [
            ...
            {"name": "toy", "price": 1, "category": "toy"},
            {"name": "pm_toy", "price": 2, "category": "toy"},
            {"name": "default_bg", "price": 10, "category": "background"},
            {"name": "default_bg2", "price": 50, "category": "background"},
